...
export default function ContactUsComponent(){
    return(
        <>
            <div className="d-flex container-fluid mt-100 justify-content-center align-items-center contato-container flex-wrap">
      <div className="position-relative w-100 w-md-25 me-md-5 mb-4 mb-md-0">
        <img className="w-100 img-fluid" src={contactPhoto} alt="Contato" />
      </div>

      <div className="d-flex flex-column h-100 justify-content-center align-items-center w-100 w-md-auto">
        <div className="d-flex flex-column container-fluid align-items-center text-center">
          <h2 className="titulo-contato">
            Junte-se a nós, e garanta mais transparência e agilidade para os seus pacientes.
          </h2>
          ...
          <div className="d-flex flex-column rounded borda sombra h-auto w-100 w-md-50 gap-2 mt-4 p-3 align-items-center justify-content-center box-form">
            ...
            <button className="btn-custom botao-suc txt-roxo-custom w-50">
        ...
        <div className="d-flex flex-column justify-content-end mt-5 align-items-center text-center w-100">
          ...
          <button className="btn-custom botao-suc mt-2 w-50 w-md-25">
